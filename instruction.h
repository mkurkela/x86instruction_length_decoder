...
static const char ins_lookup[][256] = {  
  ...
  {3,6,3,3, 0,0,0,0, 0,0,6,0, 0,12,12,12,
   ...
   3,3,3,3, 3,3,3,3, 6,6,6,6, 6,6,6,6,
   3,3,3,3, 3,3,3,3, 6,6,6,6, 6,6,6,6, 
   3,4,4,4, 3,3,3,0, 6,6,6,6, 6,6,6,6, 

   6,6,6,6, 6,6,6,6, 6,6,6,6, 6,6,6,6, 
   3,3,3,3, 3,3,3,3, 6,6,6,6, 6,6,6,6, 
   0,0,0,3, 4,3,0,0, 6,6,6,6, 6,6,6,6, 
   3,3,3,3, 3,3,3,3, 6,6,6,6, 6,6,6,6, 

   3,3,4,3, 4,4,4,3, 6,6,6,6, 6,6,6,6, 
   3,3,3,3, 3,3,3,3, 6,6,6,6, 6,6,6,6, 
   3,3,3,3, 3,3,3,3, 6,6,6,6, 6,6,6,6, 
   3,3,3,3, 3,3,3,3, 6,6,6,6, 6,6,6,6},
...
class Instruction
{
  private:
    ...
    void makePatch();
    void handleGroupFF(unsigned char *insns);
    void handleGroupF6F7(unsigned char *insns);
